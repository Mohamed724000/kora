...
| DEC-M0.3-13 | Sécurité       | M0.3-R4 impose `ajv@8.18.0 > fast-uri@3.1.6`, `prisma@7.9.1 > mysql2@3.23.1`, ainsi que `qs@6.16.0` sous `body-parser@2.3.0`, `express@5.2.1` et `superagent@10.3.0`. Les overrides restent exacts, parentés et sans sélecteur global.                                                                                 | Décision CTO M0.3-R4 / avis officiels  | Executed locally — pending commit decision |
| DEC-M0.3-14 | Automatisation | Le scanner R4 exige les cinq chemins parents exacts, les trois installations physiques racine uniques et l’absence de toute version vulnérable, variante globale, en plage, wildcard, tag, référence, mauvais parent, mauvais chemin ou override parallèle. Les gates M0.3/R1/R2 restent actifs.                       | Décision CTO M0.3-R4                   | Executed locally — pending commit decision |
| DEC-M0.3-15 | Validation     | L’état local R4 utilise le lockfile SHA-256 `E47CEA6A6853ABBDEB5A82A1D537C9C9DA92486D7A9F2EC72891A7A4101E2044` : 2 × 1 135 paquets, audits complet/production à zéro, licences 1 129/0/0, scanner 65/65, outillage 72/72 et tests globaux 61/61.                                                                       | Preuves locales M0.3-R4                | Executed locally — pending commit decision |
| DEC-M0.3-16 | Périmètre      | R4 ne change physiquement que `fast-uri`, `mysql2` et `qs`; la contrainte `sql-escaper` de `mysql2` passe de `^1.3.3` à `^1.5.1` sans changer sa résolution `1.5.1`. Aucun paquet n’est ajouté ou retiré, Prisma reste `7.9.1`, `deepmerge-ts` reste `8.0.1`, les notices restent inchangées et S1.1 demeure suspendu. | Décision CTO M0.3-R4                   | Executed locally — pending commit decision |
...
R4 traite les avis révélés par Security #44 sans changer Prisma `7.9.1`. Les
preuves R2 restent l’état publié ; DEC-M0.3-15 décrit le nouvel état local R4
soumis à une décision CTO distincte de commit. S1.1 reste préservé à 39/39 avec l’empreinte agrégée
